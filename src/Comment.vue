<template>
  <!-- gia lap comment popup -->
  <div class="cmt-h-[700px] cmt-w-[500px]">
    <!-- comment popup content -->
    <div class="cmt-bg-bgGray cmt-flex cmt-flex-col" style="height: calc(100% - 48px);">
      <div class="cmt-h-full cmt-pl-4 cmt-overflow-auto flex-grow">
        <ThreadItem
          v-for="item in fakeListComment.items"
          :key="item.id"
...
export default ({
  components: { ThreadItem, CreateComment },
  props:{},
  data(){
    return {
      fakeListComment: {
        ...
        items: [
          ...
          },
          {
            ...
            replyLatest: {
              ...
              message: '<p><span data-w-e-type="mention" class = "mention" data-w-e-is-void data-w-e-is-inline data-value="全員" data-info="%22allAccessUser%22">全員</span> test mention 2</p>',
          ...
          },
          {
            ...
            replyLatest: {
              ...
              text: 'hello 統合 二十一',
              message: '<p>hello <span data-w-e-type="mention" class = "mention" data-w-e-is-void data-w-e-is-inline data-value="統合 二十一" data-info="%22fae01a9e-a79c-4e1b-b68b-ac3c4bbd02f9%22">統合 二十一</span></p>',
